...
class SRNN_model(object):
    ...
    def __init__(self, num_classes, num_frames, num_temp_features, num_st_features, num_units, max_gradient_norm,
        ...
        self.temp_features_names = ['face-face', 'belly-belly', 'rightElbow-rightElbow', 'leftElbow-leftElbow','rightShoulder-rightShoulder','leftShoulder-leftShoulder',
                                    'rightArm-rightArm', 'leftArm-leftArm',
                                    'rightLeg-rightLeg', 'leftLeg-leftLeg']
        self.st_features_names = ['face-rightElbow','face-leftElbow',
                                  'face-leftArm', 'face-rightArm', 'face-belly','face-rightShoulder','face-leftShoulder',
                                  'rightShoulder-rightElbow','leftShoulder-leftElbow','rightShoulder-rightArm','leftShoulder-leftArm',
                                  'rightElbow-rightArm','leftElbow-leftArm',
                                  'belly-leftArm', 'belly-rightArm', 'belly-rightElbow','belly-leftElbow','belly-rightShoulder','belly-leftShoulder',
                                  'belly-rightLeg', 'belly-leftLeg', 'rightArm-leftArm', 'rightLeg-leftLeg','rightElbow-leftElbow','rightShoulder-leftShoulder']

        nodes_names = {'face', 'shoulder','elbow','arms', 'legs', 'belly'}
        ...
        weights = {'out': tf.Variable(tf.random_normal([num_units * num_frames * 6, num_classes]))}
        ...
        with tf.variable_scope("SRNN"):
            for time_step in range(num_frames):
                ...
                node_inputs['face'] = tf.concat([outputs['face-face'], outputs['face-rightArm'], outputs['face-leftArm'], outputs['face-belly'],outputs['face-rightElbow'],outputs['face-leftElbow'],outputs['face-rightShoulder'],outputs['face-leftShoulder']], 1)
                ...
                fullbody_input = tf.concat(
                    [outputs['face'], outputs['belly'],outputs['shoulder'], outputs['elbow'],outputs['arms'],
                     outputs['legs']], 1)
