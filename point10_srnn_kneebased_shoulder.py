...
class SRNN_model(object):
    ...
    def __init__(self, num_classes, num_frames, num_temp_features, num_st_features, num_units, max_gradient_norm,
        ...
        self.temp_features_names = ['face-face', 'belly-belly', 'rightShoulder-rightShoulder','leftShoulder-leftShoulder','rightKnee-rightKnee', 'leftKnee-leftKnee','rightArm-rightArm', 'leftArm-leftArm',
                                    'rightLeg-rightLeg', 'leftLeg-leftLeg']
        self.st_features_names =['face-leftArm', 'face-rightArm', 'face-belly','face-rightShoulder','face-leftShoulder','rightShoulder-rightArm','leftShoulder-leftArm',
                                 'belly-rightShoulder','belly-leftShoulder',
                                  'belly-leftArm', 'belly-rightArm', 'belly-rightKnee','belly-leftKnee','rightKnee-rightLeg','leftKnee-leftLeg',
                                  'belly-rightLeg', 'belly-leftLeg', 'rightArm-leftArm', 'rightLeg-leftLeg','rightKnee-leftKnee','rightShoulder-leftShoulder']
        nodes_names = {'face','shoulder','arms', 'knee','legs', 'belly'}
        edgesRNN = {}
        nodesRNN = {}
        states = {}
        infos = {}
        ...
        with tf.variable_scope("SRNN"):
            for time_step in range(num_frames):
                ...
                node_inputs['face'] = tf.concat([outputs['face-face'], outputs['face-rightArm'], outputs['face-leftArm'], outputs['face-belly'],outputs['face-rightShoulder'],outputs['face-leftShoulder']], 1)
                ...
                node_inputs['arms'] = tf.concat(
                    [outputs['rightArm-rightArm'], outputs['leftArm-leftArm'],outputs['face-rightArm'],outputs['rightShoulder-rightArm'],outputs['leftShoulder-leftArm'],
                ...
                fullbody_input = tf.concat(
                    [outputs['face'],outputs['shoulder'], outputs['belly'], outputs['knee'],outputs['arms'],
                     outputs['legs']], 1)
