...
class SRNN_model(object):
    ...
    def __init__(self, num_classes, num_frames, num_temp_features, num_st_features, num_units, max_gradient_norm,
        ...
        self.temp_features_names = ['face-face', 'belly-belly', 'rightArm-rightArm', 'leftArm-leftArm',
        ...
        self.st_features_names = ['face-leftArm', 'face-rightArm', 'face-belly', 'belly-leftArm', 'belly-rightArm',
                                  'belly-rightLeg', 'belly-leftLeg', 'rightArm-leftArm', 'rightLeg-leftLeg']
        ...
        weights = {'out': tf.Variable(tf.random_normal([num_units * num_frames * 4, num_classes]))}
        ...
        with tf.variable_scope("SRNN"):
            for time_step in range(num_frames):
                ...
                fullbody_input = tf.concat(
                    [outputs['face'], outputs['belly'], outputs['arms'],
                     outputs['legs']], 1)
