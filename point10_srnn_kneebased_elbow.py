...
class SRNN_model(object):
    ...
    def __init__(self, num_classes, num_frames, num_temp_features, num_st_features, num_units, max_gradient_norm,
        ...
        self.st_features_names =['face-leftArm', 'face-rightArm', 'face-belly','face-rightElbow','face-leftElbow','rightElbow-rightArm','leftElbow-leftArm',
                                 'belly-rightElbow','belly-leftElbow',
                                  ...
                                  'belly-rightLeg', 'belly-leftLeg', 'rightArm-leftArm', 'rightLeg-leftLeg','rightKnee-leftKnee','rightElbow-leftElbow']
        nodes_names = {'face','elbow','arms', 'knee','legs', 'belly'}
        edgesRNN = {}
        nodesRNN = {}
        states = {}
        infos = {}
        ...
        with tf.variable_scope("SRNN"):
            for time_step in range(num_frames):
                ...
                fullbody_input = tf.concat(
                    [outputs['face'],outputs['elbow'], outputs['belly'], outputs['knee'],outputs['arms'],
                     outputs['legs']], 1)
