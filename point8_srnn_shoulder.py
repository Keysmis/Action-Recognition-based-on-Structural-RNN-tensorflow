...
class SRNN_model(object):
    ...
    def __init__(self, num_classes, num_frames, num_temp_features, num_st_features, num_units, max_gradient_norm,
        ...
        self.temp_features_names = ['face-face', 'belly-belly', 'rightShoulder-rightShoulder', 'leftShoulder-leftShoulder','rightArm-rightArm', 'leftArm-leftArm',
                                    'rightLeg-rightLeg', 'leftLeg-leftLeg']
        self.st_features_names = ['face-rightShoulder','face-leftShoulder',
                                  'face-leftArm', 'face-rightArm', 'face-belly',
                                  'rightShoulder-rightArm','leftShoulder-leftArm',
                                  'belly-leftArm', 'belly-rightArm', 'belly-rightShoulder','belly-leftShoulder',
                                  'belly-rightLeg', 'belly-leftLeg', 'rightArm-leftArm', 'rightLeg-leftLeg','rightShoulder-leftShoulder']
        nodes_names = {'face', 'shoulder','arms', 'legs', 'belly'}
        ...
        with tf.variable_scope("SRNN"):
            for time_step in range(num_frames):
                ...
                fullbody_input = tf.concat(
                    [outputs['face'], outputs['belly'], outputs['shoulder'],outputs['arms'],
                     outputs['legs']], 1)
